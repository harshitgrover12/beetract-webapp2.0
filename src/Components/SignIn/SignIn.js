          ...
          <div className="row d-flex">
            ...
            <div className="col-lg-6">
              <div className="card2 card border-0 px-4 py-5">
                ...
                {this.state.active?(
                  <h6 className="mb-0 mr-4 mt-2" style={{fontSize:'20px'}}>Sign in with</h6>
                ):
                (<h6 className="mb-0 mr-4 mt-2" style={{fontSize:'20px'}}>Register with</h6>)
                }
              ...
              ( <div>
                ...
                <div className="row px-3"> <label className="mb-1" style={{fontSize:'20px'}}>
                    <h6 className="mb-0 text-sm" >Email</h6>
                ...
                <div className="row px-3"> <label className="mb-1">
                  ...
                  </label> <input id="password2" type="password" name="password2" placeholder="confirm password" ref={(input)=>this.password2=input} onChange={this.handleChange} /> </div>
                <div className="row px-3 mb-4">
